...
public class RawMaterialController {
    ...
    public ResponseEntity<List<RawMaterialResponseVO>> getRawMaterialList() {
        List<RawMaterialResponseVO> rawMaterialResponseVOList = service.getRawMaterialList();
        return rawMaterialResponseVOList != null ? ResponseEntity.status(HttpStatus.OK).body(rawMaterialResponseVOList) : ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(null);
    }
